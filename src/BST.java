...
public class BST<T> {
	...
	public T findMin() throws NoSuchElementException {
		if (root == null) {
			throw new NoSuchElementException("findMin(): Cannot find min value in the empty tree.");
		} else {
			return findMin(root);
		}
	}
	...
	public T findMax() throws NoSuchElementException {
		if (root == null) {
			throw new NoSuchElementException("findMax(): Cannot find max value in the empty tree.");
		} else {
			return findMax(root);
		}
	}
